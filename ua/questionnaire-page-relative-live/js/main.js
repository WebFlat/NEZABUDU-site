			...
			fetch(
				...
				.then(data => {
					...
					if (data) {
						...
						//console.log('Data:', JSON.stringify(data));
						showErrorSuccess('Дані збережені', 1000);
		...
		function goToLanguage(arr) {
			for (let i = 0; i < arr.length; i++) {
				arr[i].addEventListener('click', () => {
					...
					switch (key) {
						case 'Русский':
							window.location.href = 'https://nezabudu.com/questionnaire-page-relative-live/';
							break;
						case 'Українська':
							window.location.href = 'https://nezabudu.com/ua/questionnaire-page-relative-live/';
							break;
						case 'English':
							window.location.href = 'https://nezabudu.com/en/questionnaire-page-relative-live/';
							break;
					}
				})
			}
