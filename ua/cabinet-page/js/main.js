...
$(document).ready(function () {
	...
	function loadQuestionnaries(section_life, section_death, section_my, users, data) {
		...
		for (var key in data) {
			...
			if (data[key].profile_mine && !data[key].death_date) {
				out3 += '<a href="../questionnaire-life/#' + data[key].id + '" class="' + users + ' user item"><div class="user__info"><div class="user__avatar-wrap user__avatar-wrap--my"><img src="' + data[key].avatar + '" alt="face" class="user__avatar"></div><div class="user__title"><span class="user__surname">' + data[key].first_name + '</span><span></span><span class="user__name">' + data[key].last_name + '</span><span class="user__patronymic">' + data[key].patronymic + '</span></div><div class="user__lives"><span class="user__both">' + birth + '</span><span></div><span class="user__link-more">Читати далі</span></div></a>';
				section_my.html(out3);
				$('.customer').remove();
			} else if (!data[key].death_date && !data[key].profile_mine) {
				out += '<a href="../questionnaire-life/#' + data[key].id + '" class="' + users + ' user item"><div class="user__info"><div class="user__avatar-wrap user__avatar-wrap--life"><img src="' + data[key].avatar + '" alt="face" class="user__avatar" loading="lazy"></div><div class="user__title"><span class="user__surname">' + data[key].first_name + '</span><span></span><span class="user__name">' + data[key].last_name + '</span><span class="user__patronymic">' + data[key].patronymic + '</span></div><div class="user__lives"><span class="user__both">' + birth + '</span><span></div><span class="user__link-more">Читати далі</span></div></a>';
				section_life.addClass('not-empty');
			} else {
				out2 += '<a href="../questionnaire-life/#' + data[key].id + '" class="' + users + ' user  item"><div class="user__info"><div class="user__avatar-wrap user__avatar-wrap--death"><img src="' + data[key].avatar + '" alt="face" class="user__avatar" loading="lazy"></div><div class="user__title"><span class="user__surname">' + data[key].first_name + '</span><span></span><span class="user__name">' + data[key].last_name + '</span><span class="user__patronymic">' + data[key].patronymic + '</span></div><div class="user__lives"><span class="user__both">' + birth + '</span><span> - </span><span class="user__die">' + die + '</span></div></div><div class="user__btns"><span class="user__link-more">Читати далі</span></div></a>';
		...
		for (let key in data) {
			...
			if (data[key].death_date == null) {
				if (data[key].profile_mine == true) {
					out += '<a href="../questionnaire-life/#' + data[key].id + '" class="' + users + ' user item"><div class="user__info"><div class="user__avatar-wrap user__avatar-wrap--mine"><img src="' + data[key].avatar + '" alt="face" class="user__avatar"></div><div class="user__title"><span class="user__surname">' + data[key].first_name + '</span><span></span><span class="user__name">' + data[key].last_name + '</span><span class="user__patronymic">' + data[key].patronymic + '</span></div><div class="user__lives"><span class="user__both">' + birth + '</span><span></div><span class="user__link-more">Читати далі</span></div></a>';
				} else {
					out += '<a href="../questionnaire-life/#' + data[key].id + '" class="' + users + ' user item"><div class="user__info"><div class="user__avatar-wrap user__avatar-wrap--life"><img src="' + data[key].avatar + '" alt="face" class="user__avatar"></div><div class="user__title"><span class="user__surname">' + data[key].first_name + '</span><span></span><span class="user__name">' + data[key].last_name + '</span><span class="user__patronymic">' + data[key].patronymic + '</span></div><div class="user__lives"><span class="user__both">' + birth + '</span><span></div><span class="user__link-more">Читати далі</span></div></a>';
				}
			} else {
				out += '<a href="../questionnaire-life/#' + data[key].id + '" class="' + users + ' user  item"><div class="user__info"><div class="user__avatar-wrap user__avatar-wrap--death"><img src="' + data[key].avatar + '" alt="face" class="user__avatar"></div><div class="user__title"><span class="user__surname">' + data[key].first_name + '</span><span></span><span class="user__name">' + data[key].last_name + '</span><span class="user__patronymic">' + data[key].patronymic + '</span></div><div class="user__lives"><span class="user__both">' + birth + '</span><span> - </span><span class="user__die">' + die + '</span></div></div><div class="user__btns"><span class="user__link-more">Читати далі</span></div></a>';
			}
			section.html(out);
	...
	function validateTel() {
		...
		if (userTel == '') {
			showErrorSuccess("Будь ласка введіть дійсний номер телефону", 2000);
			return false;
		} else {
			return true;
		}
	...
	function validatePass() {
		...
		if (new_pass !== '' && new_pass.length < 6) {
			showErrorSuccess("EВведіть пароль мінімум 6 символів", 2000);
			return false;
		} else if (new_pass !== '' && new_pass !== confirm_pass) {
			showErrorSuccess("Паролі не співпадають", 2000);
			return false;
		} else {
			return new_pass;
		};
	...
	// 			const scrEncoded = ctx.canvas.toDataURL(e.target, 'image/jpeg');
	// 			var output = $('#user-icon');
	// 			output.attr('src', scrEncoded);
	// 			const url = scrEncoded;
	// 			fetch(url)
	// 				.then(res => res.blob())
	// 				.then(blob => {
	// 					const fileTo = new File([blob], `Foto_by_userid_${userId}`, { type: "image/jpeg" });
	// 					imgCompress = fileTo;
	// 					//console.log(bytesToSize(fileTo.size));
	// 				})
	// 		}
	// 	};
	// 	reader.readAsDataURL(file.files[0]);
	// 	//console.log(bytesToSize(file.files[0].size));
			...
			fetch(
				...
				.then(json => {
					if (json.error == 0) {
						...
						showErrorSuccess("Дані успішно оновлено", 2000);
						setTimeout(function () {
		...
		if (text) {
			fetch(
				...
				.then(json => {
					if (json.error == 0) {
						$('body').css('opacity', 1);
						showErrorSuccess("Повідомлення надіслано", 2000);
						$('#problemText').val('');
					} else {
						$('body').css('opacity', 1);
						showErrorSuccess("Помилка відправлення", 2000);
					}
			...
			showErrorSuccess("Введіть своє повідомлення", 2000);
		}
	})
