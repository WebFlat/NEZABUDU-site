		...
		function goToLanguage(arr) {
			for (let i = 0; i < arr.length; i++) {
				arr[i].addEventListener('click', () => {
					...
					switch (key) {
						case 'Русский':
							window.location.href = 'https://nezabudu.com/questionnaire-page-cutomer/';
							break;
						case 'Українська':
							window.location.href = 'https://nezabudu.com/ua/questionnaire-page-cutomer/';
							break;
						case 'English':
							window.location.href = 'https://nezabudu.com/en/questionnaire-page-cutomer/';
							break;
					}
				})
			}
