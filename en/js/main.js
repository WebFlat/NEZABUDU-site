        ...
        fetch(
            ...
            .then(json => {
                if (json.error == 0) {
                    ...
                    showErrorSuccess("This user already exists", 2000);
                    clearInput();
                }
            ...
            .catch(error => {
                ...
                showErrorSuccess("Connection error", 2000);
            });
    } else {
        showErrorSuccess("Connection error", 2000);
    };
...
$(document).ready(function () {
    ...
    function validateMail() {
        ...
        if (reg.test(regEmail) == false || regEmail == '') {
            showErrorSuccess("Enter the correct email", 2000);
            return false;
        } else {
            return true;
        }
    ...
    function validateSurname() {
        ...
        if (surname == '') {
            showErrorSuccess("Enter last name", 2000);
            return false;
        } else {
            return true;
        }
    ...
    function validateName() {
        ...
        if (name == '') {
            showErrorSuccess("Enter a name", 2000);
            return false;
        } else {
            return true;
        }
    ...
    function validatePatronymic() {
        ...
        if (patronymic == '') {
            showErrorSuccess("Enter your middle name", 2000);
            return false;
        } else {
            return true;
        }
    ...
    function validateTel() {
        ...
        var tel = $('#reg-tel').val();
        if (tel == '') {
            showErrorSuccess("Enter the correct phone number", 2000);
            return false;
        } else {
            return true;
        }
    ...
    function validatePass() {
        ...
        if (pass == '' || pass.length < 6) {
            showErrorSuccess("Enter a valid password of at least 6 characters", 2000);
            return false;
        } else {
            return true;
        }
            ...
            fetch(
                ...
                .then(json => {
                    if (json.error == 0) {
                        ...
                        showErrorSuccess("Such a user already exists", 2000);
                        clearInput();
                    }
                })
                .catch(error => {
    ...
    $('#authSend').click(function (e) {
        ...
        if (authPassword == '') {
            showErrorSuccess('Enter the password', 2000);
        }
                ...
                fetch(
                    ...
                    .then(json => {
                        ...
                        if (typeof json.token !== 'undefined') {
                            ...
                            showErrorSuccess('Check login and password', 2000);
                            clearInput();
                        }
    ...
    $('#remember').click(function () {
        ...
        if (validateMail(email)) {
            fetch(
                ...
                .then(json => {
                    if (json.error == 0) {
                        showErrorSuccess("The password has been sent to the email", 2000);
                    } else {
                        showErrorSuccess("Sending error", 2000);
                        clearInput();
                    }
                })
                .catch(error => {
            ...
            showErrorSuccess('Enter email first', 2000);
        }
    });
        ...
        for (let key in data) {
            ...
            if (data[key].death_date && count < 11) {
                if (isFamous) {
                    ...
                    <div class="open-profile-button button">Read more</div>
                    </a>`;
                    count++;
                } else {
                    out2 += `<a href="../questionnaire-life/#${data[key].id}" class="famous-profile-${key} famous-profile swiper-slide">
    ...
    let work_type = [
        ...
        "Writing articles about personalities",
        "Interviewing veterans",
        "Cleaning up the graves of veterans",
        "Laying flowers to veterans",
        "Cooperation with the state organizations",
        "Community collaboration",
        "Cemetery cleaning work",
        "Digitization of archives",
        "Digitization of data from monuments",
        "Monument Installation Partnership",
        "Grave Care Partnership"
    ];
...
$('.volunteer-form').submit(function (e) {
    ...
    if (validateName() == false || validateTel() == false) {
        showErrorSuccess("The data entered is incorrect!", 2000);
    } else {
        fetch(
            ...
            .then(json => {
                if (json.error == 0) {
                    showErrorSuccess("Application has been sent, we will contact you shortly", 2000);
                } else {
                    showErrorSuccess("Send error", 2000);
                }
